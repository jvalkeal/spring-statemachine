...
public class DataJpaPersistTests {
	...
	public void testSendEventE4() throws Exception {
		mvc.
			perform(get("/state").param("events", "E4").param("machine", StateMachineController.MACHINE_ID_2)).
			andExpect(status().isOk()).
			andExpect(content().string(containsString("Exit S4")));
	}
	...
	public void testChangeMachineRestores() throws Exception {
		...
		mvc.
			perform(get("/state").param("events", "E5").param("machine", StateMachineController.MACHINE_ID_2)).
			andExpect(status().isOk()).
			andExpect(content().string(containsString("Exit S5")));
	}
