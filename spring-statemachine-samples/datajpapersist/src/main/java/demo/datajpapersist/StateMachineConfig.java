...
//tag::snippetC[]
	@Bean
	public JpaRepositoryStateMachinePersist<String, String> jpaRepositoryStateMachinePersist(
			JpaStateMachineRepository jpaStateMachineRepository) {
		return new JpaRepositoryStateMachinePersist<String, String>(jpaStateMachineRepository);
	}
//end::snippetC[]
