...
public class TestResourceUtils {
	...
	public static String resourceAsStringFromClass(Class<?> baseClass, String name) throws IOException {
	...
	public static String resourceAsString(Class<?> baseClass, String name) throws IOException {
		return StreamUtils.copyToString(TestResourceUtils.namedResource(baseClass, name).getInputStream(),
				Charset.defaultCharset());
	}
	...
	public static ClassPathResource namedResource(Class<?> clazz, String resource) {
		return new ClassPathResource(String.format("%s", resource), clazz);
	}
}
