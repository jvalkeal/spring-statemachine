...
/**
 * A {@link DslParserResultError} related to missing transition target reference.
 *
 * @author Janne Valkealahti
 *
 */
public class SsmlTransitionTargetStateDslParserResultError implements DslParserResultError {
