...
//	private TopicProcessor<TriggerQueueItem> triggerProcessor = TopicProcessor.create();
//	private TopicProcessor<Flux<Message<E>>> eventProcessor = TopicProcessor.create();
