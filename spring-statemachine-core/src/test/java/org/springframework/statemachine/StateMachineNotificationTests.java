...
public class StateMachineNotificationTests extends AbstractStateMachineTests {
	...
	public void testViaChoiceLast() {
		...
		assertThat(listener.contexts.get(3)).hasStage(Stage.TRANSITION_START).hasSourceId("CHOICE").hasTargetId("S3");
		assertThat(listener.contexts.get(4)).hasStage(Stage.TRANSITION).hasSourceId("CHOICE").hasTargetId("S3");
		assertThat(listener.contexts.get(5)).hasStage(Stage.STATE_EXIT).hasSourceId("SI").doesNotHaveTarget();
		assertThat(listener.contexts.get(6)).hasStage(Stage.STATE_ENTRY).hasSourceId("SI").hasTargetId("S3");
		assertThat(listener.contexts.get(7)).hasStage(Stage.STATE_CHANGED).hasSourceId("SI").hasTargetId("S3");
		assertThat(listener.contexts.get(8)).hasStage(Stage.TRANSITION_END).hasSourceId("CHOICE").hasTargetId("S3");
	...
	public void testViaChoiceFirst() {
		...
		assertThat(listener.contexts.get(1)).hasStage(Stage.TRANSITION).hasSourceId("SI").hasTargetId("CHOICE");
		assertThat(listener.contexts.get(2)).hasStage(Stage.TRANSITION_END).hasSourceId("SI").hasTargetId("CHOICE");
		assertThat(listener.contexts.get(3)).hasStage(Stage.TRANSITION_START).hasSourceId("CHOICE").hasTargetId("S2");
		assertThat(listener.contexts.get(4)).hasStage(Stage.TRANSITION).hasSourceId("CHOICE").hasTargetId("S2");
		assertThat(listener.contexts.get(5)).hasStage(Stage.STATE_EXIT).hasSourceId("SI").doesNotHaveTarget();
		assertThat(listener.contexts.get(6)).hasStage(Stage.STATE_ENTRY).hasSourceId("SI").hasTargetId("S2");
		assertThat(listener.contexts.get(7)).hasStage(Stage.STATE_CHANGED).hasSourceId("SI").hasTargetId("S2");
		assertThat(listener.contexts.get(8)).hasStage(Stage.TRANSITION_END).hasSourceId("CHOICE").hasTargetId("S2");
		assertThat(machine).hasStateId("S2");
	...
	@Test
	public void testViaChoices() {
		StateMachine<String, String> machine = doInit(Config4.class);
		TestStateMachineListener listener = new TestStateMachineListener();
		machine.addStateListener(listener);
		...
		assertThat(listener.contexts).hasSize(15);
		assertThat(listener.contexts.get(0)).hasStage(Stage.TRANSITION_START).hasSourceId("SI").hasTargetId("CHOICE1");
		assertThat(listener.contexts.get(1)).hasStage(Stage.TRANSITION).hasSourceId("SI").hasTargetId("CHOICE1");
		assertThat(listener.contexts.get(2)).hasStage(Stage.TRANSITION_END).hasSourceId("SI").hasTargetId("CHOICE1");

		assertThat(listener.contexts.get(3)).hasStage(Stage.TRANSITION_START).hasSourceId("CHOICE1").hasTargetId("CHOICE2");
		assertThat(listener.contexts.get(4)).hasStage(Stage.TRANSITION).hasSourceId("CHOICE1").hasTargetId("CHOICE2");
		assertThat(listener.contexts.get(5)).hasStage(Stage.TRANSITION_END).hasSourceId("CHOICE1").hasTargetId("CHOICE2");

		assertThat(listener.contexts.get(6)).hasStage(Stage.TRANSITION_START).hasSourceId("CHOICE2").hasTargetId("CHOICE3");
		assertThat(listener.contexts.get(7)).hasStage(Stage.TRANSITION).hasSourceId("CHOICE2").hasTargetId("CHOICE3");
		assertThat(listener.contexts.get(8)).hasStage(Stage.TRANSITION_END).hasSourceId("CHOICE2").hasTargetId("CHOICE3");

		assertThat(listener.contexts.get(9)).hasStage(Stage.TRANSITION_START).hasSourceId("CHOICE3").hasTargetId("S3");
		assertThat(listener.contexts.get(10)).hasStage(Stage.TRANSITION).hasSourceId("CHOICE3").hasTargetId("S3");
		assertThat(listener.contexts.get(11)).hasStage(Stage.STATE_EXIT).hasSourceId("SI").doesNotHaveTarget();
		assertThat(listener.contexts.get(12)).hasStage(Stage.STATE_ENTRY).hasSourceId("SI").hasTargetId("S3");
		assertThat(listener.contexts.get(13)).hasStage(Stage.STATE_CHANGED).hasSourceId("SI").hasTargetId("S3");
		assertThat(listener.contexts.get(14)).hasStage(Stage.TRANSITION_END).hasSourceId("CHOICE3").hasTargetId("S3");
		assertThat(machine).hasStateId("S3");
	}
